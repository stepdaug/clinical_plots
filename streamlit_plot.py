...
st.write('Code to generate this page: https://github.com/stepdaug/clinical_plots/blob/main/streamlit_plot.py')
...
if st.button('Or to see a demo with some fake data, click here instead (takes a second to load)'):
